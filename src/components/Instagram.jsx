    ...
    <section id="instagram" className="py-28 overflow-hidden relative"
      ...
      <div className="max-w-5xl mx-auto px-6">
        <div className="flex flex-col md:flex-row items-center gap-14">
          ...
          {/* Profile screenshots — Instagram + TikTok */}
          <div className="shrink-0 flex flex-col sm:flex-row md:flex-col lg:flex-row items-center gap-6">
            {/* Instagram */}
            <motion.div
              ...
              <a href={IG_URL} target="_blank" rel="noopener noreferrer"
                ...
                <div className="w-56 rounded-3xl overflow-hidden shadow-2xl shadow-black/50 border-4 border-white/20 cursor-pointer">
                  <img
            ...
            <motion.div
              ...
              <a href={TIKTOK_URL} target="_blank" rel="noopener noreferrer"
                aria-label="עברו לדף הטיקטוק שלנו">
                <div className="w-56 rounded-3xl overflow-hidden shadow-2xl shadow-black/50 border-4 border-white/20 cursor-pointer">
                  <img
                  ...
                  <div className="bg-black px-4 py-3 flex items-center justify-center gap-2">
                    {TIKTOK_ICON}
                    <span className="text-white font-700 text-sm">לחצו לטיקטוק</span>
                  </div>
                </div>
              </a>
            </motion.div>
