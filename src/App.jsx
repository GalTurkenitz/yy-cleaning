    ...
    <section className="py-14 px-6" style={{ background: 'linear-gradient(160deg, #050e1f 0%, #0B2954 100%)' }}>
      <div className="max-w-lg mx-auto flex flex-col gap-4">
        <motion.a href="tel:0587222076"
          ...
          className="flex items-center justify-center gap-4 px-8 py-5 rounded-2xl bg-white text-[#0B2954] font-800 text-2xl shadow-2xl hover:bg-blue-50 transition-all hover:scale-105"
        ...
        <motion.a href={WA_URL} target="_blank" rel="noopener noreferrer"
          ...
          className="flex items-center justify-center gap-3 px-8 py-5 rounded-2xl font-800 text-2xl shadow-2xl transition-all hover:scale-105"
